...
```json
{
    ...
    "architecture": {
        "64bit": {
            "url": "https://github.com/halpworld/halpradio/releases/download/v0.2.0/halpradio_0.2.0_windows_amd64.zip",
            "bin": "halpradio.exe"
        },
        "arm64": {
            "url": "https://github.com/halpworld/halpradio/releases/download/v0.2.0/halpradio_0.2.0_windows_arm64.zip",
            "bin": "halpradio.exe"
        }
    }
}
