...
```json
{
    ...
    "architecture": {
        "64bit": {
            "url": "https://github.com/halpworld/halpradio/releases/download/v0.3.1/halpradio_0.3.1_windows_amd64.zip",
            "bin": "halpradio.exe"
        },
        "arm64": {
            "url": "https://github.com/halpworld/halpradio/releases/download/v0.3.1/halpradio_0.3.1_windows_arm64.zip",
            "bin": "halpradio.exe"
        }
    }
}
